FIX BUG WHERE THE FRONT END DOESNT UPDATE WHEN YOU SEARCH FOR A CREDENTIAL BUT IT WONT UPDATE WHEN UR ON HOME, MAKE .toLowerCase() ON BACKEND AND THE FRONT END ARRAYS FOR THE WEBSITE, AFTER SEARCH LOOK INTO OPENAPI!!!
