ADD THE ABILITY TO SEE PASSWORDS ON CARDS, FIX BUG WHERE WHEN IT UPDATES IT DOESNT SHOW AFTER CLOSE, DO THE SEARCH BAR FUNCTIONALITY, AFTER SEARCH LOOK INTO OPENAPI!!!
